...
for (P in Ps) {
    ...
    #plot(NA,NA,xlim=range(Ns), ylim = range(log10(all_errs)), xlab = 'Sample Size', ylab = 'Log Cosine', main = paste(pn_func[[func]],' dim=',P,sep=''), cex.main = 2, cex.lab = 1.5)
...
#pdf("images/legend.pdf", width = 3, height = 3)
